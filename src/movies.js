...
const detailImageElemen = document.getElementById("details_image");
bodyElement.innerHTML += getAnchors();
const anchorElements = document.querySelectorAll("a");

function showdDetails(index)
{
    detailImageElemen.src=`${httpPrefix}${data.results[index].backdrop_path}`
}
anchorElements.forEach((anchor,index) => anchor.addEventLister("click", function()
{
    showdDetails(index);
}))
